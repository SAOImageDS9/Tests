...
echo ".. char"
ds9 -title DS9Test -array rgbarray/char.rgb[dim=256,zdim=3,bitpix=8] &
KillIt

echo ".. char gzip"
ds9 -title DS9Test -array rgbarray/char.rgb.gz[dim=256,zdim=3,bitpix=8] &
KillIt

echo ".. short little"
ds9 -title DS9Test -array rgbarray/short_little.rgb[dim=256,zdim=3,bitpix=16,arch=little] &
KillIt

echo ".. short little gzip"
ds9 -title DS9Test -array rgbarray/short_little.rgb.gz[dim=256,zdim=3,bitpix=16,arch=little] &
KillIt

echo ".. short big"
ds9 -title DS9Test -array rgbarray/short_big.rgb[dim=256,zdim=3,bitpix=16,arch=big] &
KillIt

echo ".. short big gzip"
ds9 -title DS9Test -array rgbarray/short_big.rgb.gz[dim=256,zdim=3,bitpix=16,arch=big] &
KillIt

echo ".. ushort little"
ds9 -title DS9Test -array rgbarray/ushort_little.rgb[dim=256,zdim=3,bitpix=-16,arch=little] &
KillIt

echo ".. ushort little gzip"
ds9 -title DS9Test -array rgbarray/ushort_little.rgb.gz[dim=256,zdim=3,bitpix=-16,arch=little] &
KillIt

echo ".. ushort big"
ds9 -title DS9Test -array rgbarray/ushort_big.rgb[dim=256,zdim=3,bitpix=-16,arch=big] &
KillIt

echo ".. ushort big gzip"
ds9 -title DS9Test -array rgbarray/ushort_big.rgb.gz[dim=256,zdim=3,bitpix=-16,arch=big] &
KillIt

echo ".. int little"
ds9 -title DS9Test -array rgbarray/int_little.rgb[dim=256,zdim=3,bitpix=32,arch=little] &
KillIt

echo ".. int little gzip"
ds9 -title DS9Test -array rgbarray/int_little.rgb.gz[dim=256,zdim=3,bitpix=32,arch=little] &
KillIt

echo ".. int big"
ds9 -title DS9Test -array rgbarray/int_big.rgb[dim=256,zdim=3,bitpix=32,arch=big] &
KillIt

echo ".. int big gzip"
ds9 -title DS9Test -array rgbarray/int_big.rgb.gz[dim=256,zdim=3,bitpix=32,arch=big] &
KillIt

echo ".. longlong little"
ds9 -title DS9Test -array rgbarray/longlong_little.rgb[dim=256,zdim=3,bitpix=64,arch=little] &
KillIt

echo ".. longlong little gzip"
ds9 -title DS9Test -array rgbarray/longlong_little.rgb.gz[dim=256,zdim=3,bitpix=64,arch=little] &
KillIt

echo ".. longlong big"
ds9 -title DS9Test -array rgbarray/longlong_big.rgb[dim=256,zdim=3,bitpix=64,arch=big] &
KillIt

echo ".. longlong big gzip"
ds9 -title DS9Test -array rgbarray/longlong_big.rgb.gz[dim=256,zdim=3,bitpix=64,arch=big] &
KillIt

echo ".. float little"
ds9 -title DS9Test -array rgbarray/float_little.rgb[dim=256,zdim=3,bitpix=-32,arch=little] &
KillIt

echo ".. float little gzip"
ds9 -title DS9Test -array rgbarray/float_little.rgb.gz[dim=256,zdim=3,bitpix=-32,arch=little] &
KillIt

echo ".. float big"
ds9 -title DS9Test -array rgbarray/float_big.rgb[dim=256,zdim=3,bitpix=-32,arch=big] &
KillIt

echo ".. float big gzip"
ds9 -title DS9Test -array rgbarray/float_big.rgb.gz[dim=256,zdim=3,bitpix=-32,arch=big] &
KillIt

echo ".. double little"
ds9 -title DS9Test -array rgbarray/double_little.rgb[dim=256,zdim=3,bitpix=-64,arch=little] &
KillIt

echo ".. double little gzip"
ds9 -title DS9Test -array rgbarray/double_little.rgb.gz[dim=256,zdim=3,bitpix=-64,arch=little] &
KillIt

echo ".. double big"
ds9 -title DS9Test -array rgbarray/double_big.rgb[dim=256,zdim=3,bitpix=-64,arch=big] &
KillIt

echo ".. double big gzip"
ds9 -title DS9Test -array rgbarray/double_big.rgb.gz[dim=256,zdim=3,bitpix=-64,arch=big] &
KillIt
