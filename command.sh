...
testit "-prism histogram RAWX 40 0 100"
...
testit "-regions delete load regions/ds9.physical.reg"

testit "-regions save foo.reg"
testit "-regions save select foo.reg"
testit "-regions list"
testit "-regions list select"
